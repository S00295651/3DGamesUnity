...
public class TextureData : UpdatableData
{
    ...
    {
        Debug.Log($"ApplyToMaterial called - layers: {layers.Length}, minHeight: {savedMinHeight}, maxHeight: {savedMaxHeight}");
        ...
        Shader.SetGlobalFloat("minHeight", savedMinHeight);
        Shader.SetGlobalFloat("maxHeight", savedMaxHeight);
    }
